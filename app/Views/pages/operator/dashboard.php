...
<section class="p-6">
   ...
   <div class="bg-gradient-to-br from-white to-gray-50 p-6 rounded-2xl shadow-md border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 transition-all hover:shadow-lg">
    ...
    <div class="w-full md:min-w-[300px] md:max-w-md"> <!-- Diperlebar dan diperpanjang -->
        <div class="bg-gradient-to-br from-gray-50 to-white p-5 rounded-xl border border-gray-200 shadow-inner">
            <div class="flex items-center justify-between mb-3"> <!-- Jarak lebih longgar -->
                <span class="text-base font-semibold <?= $totalProgres >= 100 ? 'text-green-700' : 'text-blue-700' ?> flex items-center gap-2"> <!-- Text lebih besar -->
                    <svg class="w-5 h-5 <?= $totalProgres >= 100 ? 'text-green-500' : 'text-blue-500' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- Ikon lebih besar -->
                ...
                <span class="text-base font-bold <?= $totalProgres >= 100 ? 'text-green-600' : 'text-blue-600' ?> bg-<?= $totalProgres >= 100 ? 'green' : 'blue' ?>-100 px-3 py-1 rounded-full"> <!-- Lebih besar -->
                    <?= $totalProgres ?>%
                </span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden mb-3"> <!-- Progress bar lebih tebal -->
            ...
            <div class="flex justify-between text-sm font-medium text-gray-600"> <!-- Text lebih besar -->
                <span class="flex items-center">
                    <span class="w-2.5 h-2.5 rounded-full bg-blue-500 mr-2"></span> <!-- Bullet lebih besar -->
                    Nilai EM: <span class="font-bold ml-1"><?= number_format($totalEm, 1) ?></span>
                </span>
                <span class="flex items-center">
                    <span class="w-2.5 h-2.5 rounded-full bg-gray-500 mr-2"></span> <!-- Bullet lebih besar -->
