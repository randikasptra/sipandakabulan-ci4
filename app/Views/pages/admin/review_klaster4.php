        ...
        <div class="flex-1 flex flex-col overflow-hidden mt-24">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="max-w-5xl mx-auto">
                   ...
                   <?php if ($klaster4['status'] === 'rejected'): ?>
                        <!-- Jika Rejected, tampilkan hanya tombol hapus -->
                        <form action="<?= base_url('dashboard/admin/klaster4/delete') ?>" method="post" class="mt-8">
                            <?= csrf_field() ?>
                            <input type="hidden" name="user_id" value="<?= $user_id ?>">
                            <input type="hidden" name="tahun" value="<?= esc($klaster4['tahun']) ?>">
                            <input type="hidden" name="bulan" value="<?= esc($klaster4['bulan']) ?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php if ($klaster4['status'] === 'approved'): ?>
                        ...
                        <?php if ($klaster4['status'] === 'pending'): ?>
                            <form method="post" action="<?= base_url('dashboard/admin/klaster4/approve') ?>" class="mt-8">
                                <?= csrf_field() ?>
                                <input type="hidden" name="user_id" value="<?= $user_id ?>">
                                <input type="hidden" name="klaster" value="klaster4">
                                <input type="hidden" name="tahun" value="<?= esc($klaster4['tahun']) ?>">
                                <input type="hidden" name="bulan" value="<?= esc($klaster4['bulan']) ?>">
                                <input type="hidden" name="total_nilai" value="<?= esc($klaster4['total_nilai']) ?>">
