    ...
    <div class="flex-1 flex flex-col overflow-hidden mt-24">
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <!-- Filter Dropdown -->
                <div class="mb-6">
                    <label for="filterKlaster" class="block mb-2 text-sm font-medium text-gray-700">Filter Klaster:</label>
                ...
                <div class="space-y-8">
                    <?php foreach ($klasterData as $klaster => $items): ?>
                        <section class="bg-white rounded-xl shadow-sm p-6 klaster-section" data-klaster="<?= $klaster ?>">
                            ...
                            <?php if (!empty($items)): ?>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                    <?php foreach ($items as $item): ?>
                                        <div class="card bg-white rounded-xl shadow-card p-5 border border-gray-100 hover:shadow-card-hover">
                            ...
                            <?php else: ?>
                                <div class="text-center py-8">
                                    ...
                                    <p class="mt-1 text-sm text-gray-400">All <?= esc($klaster) ?> submissions have been processed</p>
                                </div>
                            <?php endif ?>
                        </section>
                    <?php endforeach ?>
