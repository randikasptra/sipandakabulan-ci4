<aside class="w-64 bg-blue-900 text-white flex flex-col min-h-screen">
  ...
  <nav class="flex-1 px-4 py-6 space-y-4">
    ...
    <a href="/dashboard/admin" class="flex items-center py-2 px-4 rounded hover:bg-blue-700">
      <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round"
          d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m4-8h8v8a2 2 0 01-2 2H5a2 2 0 01-2-2v-8h8z" />
      </svg>
      Dashboard
    </a>
    ...
    <a href="/dashboard/users" class="flex items-center py-2 px-4 rounded hover:bg-blue-700">
      <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round"
          d="M5 20h14a2 2 0 002-2v-2a4 4 0 00-4-4H7a4 4 0 00-4 4v2a2 2 0 002 2z" />
    ...
    <!-- Approve Data -->
    <a href="/dashboard/approve_list" class="flex items-center py-2 px-4 rounded hover:bg-blue-700">
      <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <a href="/dashboard/settings" class="flex items-center py-2 px-4 rounded hover:bg-blue-700">
      <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round"
          d="M11 3h2m-1 0v4m-4.243 1.757l2.829-2.828M12 12a3 3 0 100-6 3 3 0 000 6zM3 12h4m13 0h-4m1.757 4.243l-2.829 2.828M13 21v-4m-6.243-1.757l2.829-2.828" />
      </svg>
      Pengaturan
    </a>
