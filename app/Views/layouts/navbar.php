...
<nav class="bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 px-6 py-4 shadow-xl fixed w-full top-0 z-50 backdrop-blur-sm border-b border-blue-600/30">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        <!-- Logo/Brand Section - Diperbesar -->
        <div class="flex items-center space-x-4">
            <div class="w-12 h-12 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center shadow-lg border border-blue-500/20">
            ...
            <div class="relative">
                ...
                <div x-show="dropdownOpen" @click.outside="dropdownOpen = false"
                    ...
                    <button type="button"
                        ...
                        class="block w-full text-left px-5 py-3 text-sm text-gray-700 hover:bg-gray-100 transition-colors flex items-center">
    ...
    <!-- Mobile Menu Dropdown - Diperbesar -->
